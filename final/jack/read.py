...
'''word2vec_model = word2vec.Word2Vec(train_span , min_count = 1, size = 256 , iter = 10)
...
inner = LSTM(256 , return_sequences = True, input_length = 50, input_dim = 260, dropout = 0.5, recurrent_dropout = 0.5, kernel_initializer='he_normal')(q_input)
